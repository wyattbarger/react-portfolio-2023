    ...
    return (
        <section className="bg-black text-gray-200 flex bg-gradient-to-r from-gray-950 via-black to-black">
            <div className='pl-9 pt-9 pb-5 flex flex-col max-w-md ml-auto'>
                ...
                <Link className="text-gray-900 hover:text-cyan-700 hover:border-cyan-700 border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-bold rounded-lg text-sm px-2 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800 font-league-spartan" to="/contact">Contact Wyatt</Link>
            </div>
